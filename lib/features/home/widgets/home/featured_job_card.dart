              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(14.r),
                      child: job.company!.logoCompany != null && job.company!.logoCompany!.isNotEmpty
                        ? Image.network(
                        ...
                        : Center(
                            child: Text(
                              job.company!.companyName.substring(0, 1) .toUpperCase(),
                  ...
                  Icon(Icons.bookmark_border_rounded, color: Theme.of(context).colorScheme.outline, size: 26.sp)
                ],
              ),
