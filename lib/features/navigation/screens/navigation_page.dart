...
import 'package:job_connect/config/widgets/appbar_drawer.dart';
...
class NavigationPage extends StatefulWidget {
  ...
  final String idUser;
  const NavigationPage({super.key, this.isLoggedIn = false, required this.idUser});

  static final GlobalKey<NavigationPageState> homeKey = GlobalKey<NavigationPageState>();
  ...
  static void goToProfileTab(BuildContext context) {
    ...
    if (state == null || !state.mounted) {
      print(
        "[NavigationPage] goToProfileTab: NavigationPageState is not available or not mounted.",
      );
      return;
    }
  ...
  static void goToSavedJobsTab(BuildContext context) {
    ...
    if (state == null || !state.mounted) {
      print(
        "[NavigationPage] goToSavedJobsTab: NavigationPageState is not available or not mounted.",
      );
      return;
    }
        ...
        child: SlideTransition(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: theme.shadowColor.withValues(alpha:isDarkMode ? 0.25 : 0.1),
                  blurRadius: 20,
                  spreadRadius: 2,
